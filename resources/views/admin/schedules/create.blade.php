    ...
    <form method="POST" action="{{ route('admin.schedules.store') }}" class="space-y-4">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" name="lokasi_pemeriksaan" value="{{ old('lokasi_pemeriksaan', config('mcu.default_location')) }}" required class="w-full rounded-lg border border-gray-200 px-3 py-2 text-theme-sm dark:border-gray-800 dark:bg-gray-800 dark:text-white/90" placeholder="Klinik Utama Balaikota">
