...
<x-common.component-card title="Form Hasil MCU">
    <form method="POST" action="{{ route('admin.mcu-results.update', $mcuResult) }}" class="space-y-4">
        @csrf
        <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" name="diagnosis" value="{{ old('diagnosis', $mcuResult->diagnosis) }}" class="w-full rounded-lg border border-gray-200 px-3 py-2 text-theme-sm dark:border-gray-800 dark:bg-gray-800 dark:text-white/90">
            </div>
            <div class="sm:col-span-2">
            ...
            <div class="sm:col-span-2">
                ...
                <textarea name="rekomendasi" rows="2" class="w-full rounded-lg border border-gray-200 px-3 py-2 text-theme-sm dark:border-gray-800 dark:bg-gray-800 dark:text-white/90">{{ old('rekomendasi', $mcuResult->rekomendasi) }}</textarea>
            </div>
            <div>
