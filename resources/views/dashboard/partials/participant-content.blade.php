...
<div class="row mb-4">
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="stats-card">
            <div class="stats-icon"><i class="fas fa-people-group"></i></div>
            <div class="stats-number">{{ $todayQueueTotal ?? 0 }}</div>
...
<div class="row">
    <div class="col-lg-6 mb-4">
        <div class="card">
            <div class="card-header"><h5 class="mb-0"><i class="fas fa-user-circle me-2"></i>Status Profile</h5></div>
            <div class="card-body">
                @if($participant)
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <div class="user-avatar" style="width: 60px; height: 60px; font-size: 1.5rem;">{{ strtoupper(substr($participant->nama_lengkap, 0, 1)) }}</div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1">{{ $participant->nama_lengkap }}</h6>
                            <p class="text-muted mb-1">{{ $participant->skpd }}</p>
                            <span class="badge bg-{{ $participant->status_mcu_color }}">{{ $participant->status_mcu }}</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6"><small class="text-muted">NIK KTP</small><p class="mb-2"><strong>{{ $participant->nik_ktp }}</strong></p></div>
                        <div class="col-6"><small class="text-muted">Status Pegawai</small><p class="mb-2"><strong>{{ $participant->status_pegawai }}</strong></p></div>
                        <div class="col-6"><small class="text-muted">Umur</small><p class="mb-2"><strong>{{ $participant->umur }} tahun</strong></p></div>
                        <div class="col-6"><small class="text-muted">Jenis Kelamin</small><p class="mb-2"><strong>{{ $participant->jenis_kelamin_text }}</strong></p></div>
                    </div>
                    <a href="{{ route('client.profile') }}" class="btn btn-primary w-100"><i class="fas fa-edit me-2"></i>Lihat Profile Lengkap</a>
                @else
                    <div class="text-center py-4">
                        ...
                        <a href="{{ route('client.profile') }}" class="btn btn-primary"><i class="fas fa-user-plus me-2"></i>Lengkapi Profile</a>
                    </div>
                @endif
            </div>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <a href="{{ route('client.schedules') }}" class="btn btn-outline-primary w-100 h-100 d-flex flex-column align-items-center justify-content-center">
                            <i class="fas fa-calendar fa-2x mb-2"></i><span>Jadwal MCU</span>
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="{{ route('client.results') }}" class="btn btn-outline-success w-100 h-100 d-flex flex-column align-items-center justify-content-center">
                            <i class="fas fa-file-medical fa-2x mb-2"></i><span>Hasil MCU</span>
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="{{ route('client.schedule.request') }}" class="btn btn-outline-warning w-100 h-100 d-flex flex-column align-items-center justify-content-center">
                            <i class="fas fa-repeat fa-2x mb-2"></i><span>Daftar Ulang MCU</span>
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="{{ route('client.profile') }}" class="btn btn-outline-info w-100 h-100 d-flex flex-column align-items-center justify-content-center">
                            <i class="fas fa-user fa-2x mb-2"></i><span>Profile</span>
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn btn-outline-danger w-100 h-100 d-flex flex-column align-items-center justify-content-center">
                            <i class="fas fa-sign-out-alt fa-2x mb-2"></i><span>Logout</span>
                        </a>
...
<div class="row">
    <div class="col-lg-6 mb-4">
        <div class="card">
            <div class="card-header"><h5 class="mb-0"><i class="fas fa-calendar-alt me-2"></i>Jadwal MCU Terdekat</h5></div>
            <div class="card-body">
                @if($schedules->count() > 0)
                    @foreach($schedules->take(3) as $schedule)
                        <div class="d-flex align-items-center mb-3 p-3 border rounded">
                            <div class="flex-shrink-0">
                                <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;"><i class="fas fa-calendar-check"></i></div>
                            </div>
                            <div class="flex-grow-1 ms-3">
                    ...
                    @endforeach
                    <a href="{{ route('client.schedules') }}" class="btn btn-outline-primary w-100"><i class="fas fa-eye me-2"></i>Lihat Semua Jadwal</a>
                @else
                    <div class="text-center py-4">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card">
            <div class="card-header"><h5 class="mb-0"><i class="fas fa-chart-line me-2"></i>Hasil MCU Terbaru</h5></div>
            <div class="card-body">
                @if($mcuResults->count() > 0)
                    ...
                    @endforeach
                    <a href="{{ route('client.results') }}" class="btn btn-outline-success w-100"><i class="fas fa-eye me-2"></i>Lihat Semua Hasil</a>
                @else
                    <div class="text-center py-4">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4"><div class="text-center"><i class="fas fa-shield-alt fa-2x text-primary mb-2"></i><h6>Sistem Aman</h6><p class="text-muted small">Data Anda dilindungi dengan sistem keamanan tingkat tinggi</p></div></div>
                    <div class="col-md-4"><div class="text-center"><i class="fas fa-clock fa-2x text-warning mb-2"></i><h6>24/7 Tersedia</h6><p class="text-muted small">Sistem dapat diakses kapan saja dan di mana saja</p></div></div>
                    <div class="col-md-4"><div class="text-center"><i class="fas fa-headset fa-2x text-success mb-2"></i><h6>Dukungan Penuh</h6><p class="text-muted small">Tim support siap membantu Anda kapan saja</p></div></div>
                </div>
            </div>
        </div>
    </div>
